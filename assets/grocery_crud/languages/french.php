...
/* Translated by Tony LAURENT */
	...
	/* Javascript messages */
	$lang['alert_add_form']			= 'Les données que vous avez inserées ne sont pas enregistrées.\\nÊtes vous sûr de vouloir retourner à la liste ?';
	$lang['alert_edit_form']		= 'Les données que vous avez modifiées ne sont pas enregistrées.\\nÊtes vous sûr de vouloir retourner à la liste ?';
	$lang['alert_delete']			= "Êtes-vous sûr de vouloir supprimer cet enregistrement ?<p><b>Conséquences:</b> Suppression des autres 		enregistrements liées à celui-ci.</p><p>Soyez sûr que d'autre enregistrements ne sont pas liées à celui-ci avant de supprimer.</p> ";
