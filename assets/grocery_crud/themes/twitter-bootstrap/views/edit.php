...
?>
<div class="twitter-bootstrap crud-form span6 offset3">
<div class="well">
	...
	<div id="main-table-box">
		<?php
		echo form_open( $update_url, 'method="post" id="crudForm" class="form-div" autocomplete="off" enctype="multipart/form-data"');
			...
			<!--<input type="button" value="<?php //echo $this->l('form_update_changes'); ?>" class="btn btn-primary submit-form"/>-->
			<?php 	if(!$this->unset_back_to_list) { ?>
				<input type="button" value="<?php echo $this->l('form_update_and_go_back'); ?>" id="save-and-go-back-button" class="btn btn-primary"/>
				<input type="button" value="<?php echo $this->l('form_cancel'); ?>" class="btn return-to-list" />
			<?php 	} ?>
