...
<div class="well">
	...
	<div id="main-table-box">
		<?php
		echo form_open( $insert_url, 'method="post" id="crudForm" class="form-div" autocomplete="off" enctype="multipart/form-data"');
			...
			<!--<input type="button" value="<?php //echo $this->l('form_save'); ?>"  class="btn btn-primary submit-form"/>-->
